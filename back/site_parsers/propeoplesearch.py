...
def propeoplesearch(name, surename, state='', city=''):
    cookies = {
    ...
    response = requests.post('https://propeoplesearch.com/ld/people/default/processing', cookies=cookies,
                             headers=headers, data=data)

    if response.status_code == 200:
        response2 = requests.get('https://propeoplesearch.com/ld/people/default/loading-results', cookies=cookies,
                                 headers=headers)
